...
mouse_sensitivity = 0.005  # Sensibilidad del movimiento del mouse
...
while True:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            dx, dy = event.rel
            poly_data['rotation'][1] -= dx * mouse_sensitivity  # Rotar horizontal
            poly_data['rotation'][0] -= dy * mouse_sensitivity  # Rotar vertical
